-- Fix Gallery Tables Foreign Key and RLS Issues
-- This fixes the mismatch between event_id storage and RLS policies
...
-- Drop the incorrect RLS policies
...
-- Also add a policy for admins to see all albums
