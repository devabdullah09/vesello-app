          ...
          <div className="w-full max-w-[1200px] mx-auto flex flex-col items-center mb-8 mt-2 z-10 px-16 pt-12 pb-8">
            <div className="text-center w-full mb-10">
              <div className="flex flex-col items-center">
                <span className="text-3xl md:text-4xl" style={{ fontFamily: 'Great Vibes, cursive', fontWeight: 500, color: '#E5B574', letterSpacing: '0.5px', lineHeight: 1.1 }}>{t.invitation.needTransportation}</span>
                <span className="text-3xl md:text-4xl" style={{ fontFamily: 'Great Vibes, cursive', fontWeight: 500, color: '#08080A', letterSpacing: '0.5px', lineHeight: 1.1, fontStyle: 'italic', marginTop: '0.5rem' }}>{t.invitation.toOurWeddingDay}</span>
