          ...
          <div className="w-full flex justify-center mb-8">
            <div className="border border-[#E5B574] rounded-md py-8 px-8 flex flex-col items-center bg-white" style={{ minWidth: 340, maxWidth: 400 }}>
              ...
              <div className="flex flex-row gap-8">
                <button className="flex flex-col items-center px-6 py-4" style={{ minWidth: 120 }} onClick={() => router.push(`/event-id/${wwwId}/gallery/wedding-day`)}>
                  <Image src="/images/Gallery/weddingDay.png" alt={t.gallery.weddingDay} width={78} height={78} className="mb-2" />
                  <span className="mt-2" style={{ fontFamily: 'Montserrat', fontWeight: 500 }}>{t.gallery.weddingDay}</span>
                </button>
                <button className="flex flex-col items-center px-6 py-4" style={{ minWidth: 120 }} onClick={() => router.push(`/event-id/${wwwId}/gallery/party-day`)}>
                  <Image src="/images/Gallery/afterPArty.png" alt={t.gallery.afterParty} width={78} height={78} className="mb-2" />
                  <span className="mt-2" style={{ fontFamily: 'Montserrat', fontWeight: 500 }}>{t.gallery.afterParty}</span>
                </button>
              </div>
            </div>
          </div>
